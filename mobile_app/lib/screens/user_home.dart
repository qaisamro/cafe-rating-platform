              ...
              child: CustomScrollView(
                ...
                slivers: [
                          ...
                          Row(
                            ...
                            children: [
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('مساء النور ✨', style: GoogleFonts.cairo(color: Colors.white.withOpacity(0.75), fontSize: 15)),
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('المقاهي المميزة ☕', style: GoogleFonts.cairo(fontSize: 22, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
                          GestureDetector(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Row(children: [
                                        ...
                                        SizedBox(width: 4),
                                        Text('${cafe['rating'] ?? '4.8'}', style: GoogleFonts.cairo(fontWeight: FontWeight.w700, fontSize: 13, color: AppColors.textMuted)),
                                      ])
                                    ]),
                                  ),
                                ],
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: EdgeInsets.symmetric(horizontal: 24),
                      child: Text('اكتشف المنيو 🍽️', style: GoogleFonts.cairo(fontSize: 22, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
                    ),
                  ),
                  SliverToBoxAdapter(child: SizedBox(height: 16)),
                  SliverPadding(
                        ...
                        (ctx, i) {
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Padding(padding: EdgeInsets.only(top: 4), child: Text('اضغط لعرض الكافيه', style: GoogleFonts.cairo(color: AppColors.textMuted, fontSize: 13))),
                              trailing: Container(
